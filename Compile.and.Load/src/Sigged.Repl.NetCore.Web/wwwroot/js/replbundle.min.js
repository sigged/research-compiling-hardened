 ...
 * @license MIT
 */
let replService=function(){const n=new Vue({el:"#repl-main-ide",data:{isBuilding:!1,isRunning:!1,statusText:"Ready for action...",builderrors:[{severity:"error",id:"CS 00000",location:"Line 15, Col 4",description:"Totally bogus error for testing purproses"},]},methods:{buildSource:function(){this.isBuilding=!0;this.statusText="Building...";this.$submitCodeForBuilding(sourceInput.value)},buildAndRunSource:function(){},runSource:function(){console.log("Running..");this.statusText="Running...";this.isBuilding=!1;this.isRunning=!0},stopAll:function(){this.isBuilding=!1;this.isRunning=!1;this.statusText="User cancelled"},appStopped:function(){this.isBuilding=!1;this.isRunning=!1;this.statusText="Application ended"},$buildSuccess:function(){this.isBuilding=!1;this.isRunning=!1;this.builderrors=null;this.statusText="Build succeeded"},$buildFailed:function(n){this.isBuilding=!1;this.isRunning=!1;this.builderrors=n;this.statusText="Build failed"},$submitCodeForBuilding:function(n){let t=new XMLHttpRequest,i=this;t.onload=function(){if(t.status!==200){console.err("HTTP error while submitting code",t.status);return}let r=t.response,n=JSON.parse(r);n.isSuccess?i.$buildSuccess():i.$buildFailed(n.buildErrors)};t.onerror=function(){console.err("Generic error while submitting code",t.event)};t.onprogress=function(){};let r=JSON.stringify({sourceCode:n});t.open("POST","/Home/Build");t.setRequestHeader("Content-type","application/json; charset=utf-8");t.send(r)}}})}();
//# sourceMappingURL=replbundle.min.js.map