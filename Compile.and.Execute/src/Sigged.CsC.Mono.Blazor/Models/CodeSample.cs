        ...
        public static IEnumerable<CodeSample> GetSamples()
        {
            return new List<CodeSample>{
                new CodeSample{
                  ...
                  Name= "Hello World",
                  Category = "Harmless",
                  Contents = SampleContent["hello-world"]
                ...
                new CodeSample{
                  ...
                  Name= "Random Numbers",
                  Category = "Harmless",
                  Contents = SampleContent["random-numbers-1"]
                ...
                new CodeSample{
                  ...
                  Name= "Text Input",
                  Category = "Harmless",
                  Contents = SampleContent["text-input-1"]

                },
                new CodeSample
                {
                  Id = "environment-systeminfo",
                  Name = "Environment: System Info",
                  Category = "Threats",
                  Contents = SampleContent["environment-systeminfo"]
                },
                new CodeSample
                {
                  ...
                  Category = "Threats",
                  Contents = SampleContent["environment-variables"]
                },
                new CodeSample
                {
                  Id = "filesystem-createfile-1",
                  Name = "Filesystem: Create file",
                  Category = "Threats",
                  Contents = SampleContent["filesystem-createfile-1"]
                },
                new CodeSample
                {
                  Id = "filesystem-enumeration-1",
                  Name = "Filesystem: Enumerate",
                  Category = "Threats",
                  Contents = SampleContent["filesystem-enumeration-1"]
                },
                new CodeSample
                {
                  Id = "net-apicall-1",
                  Name = "Network: Call remote service",
                  Category = "Threats",
                  Contents = SampleContent["net-apicall-1"]
                },
                new CodeSample
                {
                  Id = "net-remoteshell-1",
                  Name = "Network: Reverse Shell",
                  Category = "Threats",
                  Contents = SampleContent["net-remoteshell-1"]
                },
                new CodeSample
                {
                  Id = "processes-create-1",
                  Name = "Processes: Spawn Process",
                  Category = "Threats",
                  Contents = SampleContent["processes-create-1"]
                }
            };
        }

        private static Dictionary<string, string> SampleContent
        {
            get
            {
...
namespace Threats.Network.CallRemoteService
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            Console.WriteLine(""Chuck Norris Joke:"");
            Console.WriteLine(""----------------------------"");
        ...
        static async Task<T> GetContent<T>(HttpClient client, string path)
        {
            T result = default(T);
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                result = JSONParser.FromJson<T>(json);
            }
            return result;
        }
    }
    ...
    /// MIT License (MIT)
    /// Courtesy of https://github.com/zanders3/json 
